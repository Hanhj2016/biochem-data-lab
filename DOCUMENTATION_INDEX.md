...
Use this page to choose the right guide without opening every `.md` file.

All project data are synthetic and for learning only. Do not treat outputs as clinical, diagnostic, regulatory, drug-efficacy, or real biological evidence.
...
| Need | Open |
|---|---|
| Quick setup | [Setup_Guide/00_Quick_Start.md](Setup_Guide/00_Quick_Start.md) |
| Windows setup | [Setup_Guide/01_Windows11_Setup.md](Setup_Guide/01_Windows11_Setup.md) |
| Ubuntu setup | [Setup_Guide/02_Ubuntu24_Setup.md](Setup_Guide/02_Ubuntu24_Setup.md) |
| macOS setup | [Setup_Guide/03_macOS_Setup.md](Setup_Guide/03_macOS_Setup.md) |
| R kernel setup | [Setup_Guide/04_R_Kernel_IRkernel_Setup.md](Setup_Guide/04_R_Kernel_IRkernel_Setup.md) |
